...
public class GcExcelHelper {
    ...
    public void genGraphs(){
        ...
        shape1.getChart().getChartTitle().setText(Strings.GRAPH_2_TITLE+DocHelper.getStartingYear()+"/"+nextYear);
        ...
        shape2.getChart().getChartTitle().setText(Strings.GRAPH_3_TITLE+DocHelper.getStartingYear()+"/"+nextYear);
        ...
        shape3.getChart().getChartTitle().getTextFrame().getTextRange().getParagraphs().add(Strings.GRAPH_4_TITLE+DocHelper.getStartingYear()+"/"+nextYear);
        ...
        shape4.getChart().getChartTitle().getTextFrame().getTextRange().getParagraphs().add(Strings.GRAPH_5_TITLE+DocHelper.getStartingYear()+"/"+nextYear);
        ...
        IShape shape6 = worksheet8.getShapes().addChart(ChartType.Pie, 250, 20, 360, 230);
        shape6.getChart().getSeriesCollection().add(worksheet8.getRange("A1:B8"), RowCol.Columns, true, true);
        ...
        IShape shape7 = worksheet9.getShapes().addChart(ChartType.LineMarkers, 250, 20, 360, 230);
        shape7.getChart().getSeriesCollection().add(worksheet9.getRange("A2:B13"), RowCol.Columns, true, true);
        ...
        IShape shape8 = worksheet10.getShapes().addChart(ChartType.LineMarkers, 250, 20, 360, 230);
        shape8.getChart().getSeriesCollection().add(worksheet10.getRange("A2:B13"), RowCol.Columns, true, true);
        ...
        IShape shape9 = worksheet11.getShapes().addChart(ChartType.LineMarkers, 250, 20, 360, 230);
        shape9.getChart().getSeriesCollection().add(worksheet11.getRange("A1:C13"), RowCol.Columns, true, true);
